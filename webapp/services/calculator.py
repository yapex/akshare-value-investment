...
class Calculator:
    ...
    @staticmethod
    def calculate_cash_flow_pattern(symbol: str, market: str, years: int) -> Tuple[pd.DataFrame, List[str], Dict[str, any]]:
        """计算现金流类型分析（包含数据获取）
    ...
    def calculate_dcf_valuation(
        ...
        stats = {
            ...
            # 计算市场隐含增长率的方法
            "implied_growth_rate": lambda market_cap: Calculator._calculate_implied_growth_rate(
